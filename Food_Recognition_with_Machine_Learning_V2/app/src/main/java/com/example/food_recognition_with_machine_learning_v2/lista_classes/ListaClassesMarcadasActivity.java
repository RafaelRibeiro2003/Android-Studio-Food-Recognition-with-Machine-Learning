...
public class ListaClassesMarcadasActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Titulo
        ((TextView) findViewById(R.id.texto_titulo_lista)).setText("Lista de Classes Marcadas");

        database = new Database(this);
        List<ClassItem> classList = getMarkedClasses();
    ...
    private List<ClassItem> getMarkedClasses() {
